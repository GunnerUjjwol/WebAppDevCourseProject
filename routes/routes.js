...
router.post('/behavior/reportSelection', behaviorReportingController.reportSelection)
router.get('/behavior/reportSelection', behaviorReportingController.reportSelectionForm)
